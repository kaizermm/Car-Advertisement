...
vehicle_ad_data=pd.read_csv('vehicles_us.csv',engine = 'python')
...
show_scatter = st.checkbox("Show Scatter Plot for price and age")
...
show_scatter = st.checkbox("Show Scatter Plot for Mileage of a vehicle")
